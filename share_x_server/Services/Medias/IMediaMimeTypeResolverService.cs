...
/// <summary>Media Mime-type resolver service</summary>
public interface IMediaMimeTypeResolverService
{
    /// <summary>Attempts to resolve correct mime-type for suggested type and checks header bytes for additional validation.</summary>
